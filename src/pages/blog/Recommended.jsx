...
const Recommended = () => {
  return (
     <div className='recomendaciones'>
      ...
      <h1 className="titulo">Productos recomendados ✨</h1>
        <p className='parrafo-titulo'>En esta sección se destacan algunos productos de belleza que suelen ser recomendados según el tipo de piel, 
          ...
          En Sweet Glow se pueden presentar recomendaciones organizadas por categorías para que cada persona encuentre fácilmente lo que necesita.</p>

      <h3 className='productos'>Productos recomendados para piel grasa</h3>
        <p className='prod'>Las personas con piel grasa necesitan productos que ayuden a controlar el exceso de sebo, reducir el brillo y mantener los poros limpios, sin resecar demasiado la piel.

          <h4>Productos recomendados</h4>
          Limpiadores faciales en gel que eliminan el exceso de grasa.
          Tónicos equilibrantes que ayudan a minimizar los poros.
          Hidratantes ligeros libres de aceite (oil-free).
          Sérums con ingredientes que regulen la producción de sebo.</p>
      ...
      <h3 className='productos'>Productos recomendados para piel seca</h3>
        <p className='prod'>La piel seca necesita productos que aporten hidratación profunda y nutrientes, para evitar la sensación de tirantez y descamación.
          ...
          Limpiadores cremosos que no resequen la piel.
      ...
      <h3 className='productos'>Maquillaje según tu tono de piel</h3>
        <p className='prod'>Elegir el maquillaje adecuado según el tono y subtono de piel permite lograr un resultado más natural y armonioso.
          ...
          Piel oscura: colores intensos como vino, ciruela o bronce.</p>
      ...
      <h3 className='productos'>Fragancias más populares</h3>
        <p className='prod'>Las fragancias también forman parte del estilo personal.
          ...
          Estas fragancias son conocidas por su aroma característico y su popularidad en el mundo de la perfumería</p>


      <h3 className='productos'>Importancia de elegir productos adecuados</h3>
        <p className='prod'>Cada persona tiene necesidades diferentes en cuanto al cuidado de la piel y el maquillaje. Por eso, elegir productos adecuados según el tipo de piel,
           tono de piel y preferencias personales permite obtener mejores resultados.
           En Sweet Glow, esta sección puede servir como guía para descubrir productos que ayuden a mejorar la rutina de belleza y encontrar opciones que se adapten a cada estilo.</p>
