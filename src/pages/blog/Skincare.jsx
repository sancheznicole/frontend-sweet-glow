...
const Skincare = () => {
  return (
    <div className='skin'>
      ...
      <h1 className="titulo">Guía para una Piel Perfecta ✨</h1>
      ...
      <h3 className='tipo-piel'>Piel Seca</h3>
        <p className='piel-p'>La piel seca se caracteriza por producir menos aceites naturales de lo normal. Esto puede provocar que la piel se sienta tirante,
          áspera o con descamación. Las personas con este tipo de piel suelen notar que su rostro pierde hidratación fácilmente, especialmente después de lavarse la cara o en climas fríos.
          ...
          Ácido hialurónico: ayuda a retener el agua en la piel y mantenerla hidratada.
          Ceramidas: fortalecen la barrera protectora de la piel.
          Glicerina: atrae y retiene la humedad.
          Manteca de karité: nutre y suaviza la piel.

          <h4>Productos recomendados</h4>
          Cremas hidratantes intensivas
          Sérums hidratantes
          Limpiadores suaves o cremosos
          Mascarillas nutritivas</p>
      ...
      <h3 className='tipo-piel'>Piel mixta</h3>
        <p className='piel-p'>La piel mixta es una combinación de piel grasa y piel seca. Generalmente la zona T del rostro (frente, nariz y mentón) 
          ...
          <h4>Ingredientes recomendados</h4>
          Niacinamida: ayuda a equilibrar la piel
          Ácido hialurónico: hidrata sin dejar sensación pesada
          Extractos naturales calmantes: ayudan a mantener el equilibrio de la piel

          <h4>Productos recomendados</h4>
          Limpiadores suaves
          Hidratantes ligeros
          Tónicos equilibrantes
          Mascarillas específicas para cada zona del rostro</p>
      ...
      <h3 className='tipo-piel'>Piel Grasa</h3>
        <p className='piel-p'>La piel grasa produce una mayor cantidad de sebo (aceite natural). Esto puede provocar brillo excesivo en el rostro, 
          ...
          Poros más grandes
          Aparición de puntos negros o espinillas
          Mayor tendencia al acné

          <h4>Ingredientes recomendados</h4>
          Niacinamida: regula la producción de sebo.
          Ácido salicílico: limpia los poros y ayuda a prevenir el acné.
          Zinc: ayuda a controlar el brillo.
          Arcilla: absorbe el exceso de grasa.

          <h4>Productos recomendados</h4>
          Limpiadores en gel
          Tónicos equilibrantes
          Sérums para controlar grasa
          Hidratantes ligeros libres de aceite (oil-free)</p>
      ...
      <h3 className='tipo-piel'>Piel sensible</h3>
        <p className='piel-p'>La piel sensible reacciona con mayor facilidad a factores externos como el clima, la contaminación o ciertos productos cosméticos.
          ...
          Irritación con algunos productos
          Mayor sensibilidad a factores ambientales

          <h4>Ingredientes recomendados</h4>
          Aloe vera: ayuda a calmar la piel
          Avena coloidal: reduce la irritación
          Manzanilla: tiene propiedades calmantes
          Pantenol (vitamina B): ayuda a reparar la piel

          <h4>Productos recomendados</h4>
          Limpiadores suaves sin fragancia
          Cremas calmantes
          Productos hipoalergénicos
          Protectores solares para piel sensible</p>
      ...
      <h3 className='tipo-piel'>Importancia de elegir productos adecuados</h3>
        <p className='piel-p'>Utilizar productos adecuados según el tipo de piel es clave para mantener una piel sana. Además,
          ...
          En Sweet Glow buscamos ayudar a cada persona a encontrar productos que se adapten a sus necesidades y contribuyan al cuidado adecuado de su piel.</p>
