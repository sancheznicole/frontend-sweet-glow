...
export async function getAllReferencias(page, limit) {
    try {
        const res = await axios.get(`${API_URL}/referencia?page=${page}&limit=${limit}`)
...
export async function getReferencia(id_referencia) {
    try {
        const res = await axios.get(`${API_URL}/referencia/${id_referencia}`)
...
export async function CreateReferencia(codigo, color, tamaño) {
    try {
        ...
        const res = await axios.post(`${API_URL}/referencia`, payload)
...
export async function updateReferencia(id_referencia, codigo, color, tamaño) {
    try {
        ...
        const res = await axios.put(`${API_URL}/referencia/${id_referencia}`, datos)
...
export async function deleteReferencia(id_referencia) {
    try {
        const res = await axios.delete(`${API_URL}/referencia/${id_referencia}`)
