...
export async function getAllReferenceProducts(page = 1, limit = 5, search) {
    try {
        const res = await axios.get(`${API_URL}/product_references?page=${page}&limit=${limit}&search=${search}`)
